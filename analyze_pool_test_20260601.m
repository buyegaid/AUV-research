...
% 数据文件: data/debug_data260601-1.csv (2026-06-01 水池测试, ~49分钟)
...
%
% 输出:
%   - pic/pool_test_20260601_segmentation.png  (分段总览)
%   - pic/pool_test_20260601_sysid.png         (系统辨识结果)
%   - pic/pool_test_20260601_comparison.png    (修复前后对比)
%   - pic/pool_test_20260601_thrusters.png     (推进器推力分析)
%   - 控制台输出关键辨识参数
...
%% ===== 配置 =====
DATA_FILE = 'data/debug_data260601-1.csv';
PREV_DATA_FILE = 'data/debug_data260530-1.csv';  % 上次故障数据(对比用)
