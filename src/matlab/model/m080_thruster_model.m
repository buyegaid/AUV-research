function state = m080_thruster_model(pwm_us, voltage_v, params)
%M080_THRUSTER_MODEL M080 深水推进器 PWM 到推力/扭矩的准静态模型
%
% 输入:
%   pwm_us    - PWM 脉宽, 单位 us, 可为标量或数组
%   voltage_v - 供电电压, 单位 V, 默认 24 V, 可为标量或与 pwm_us 同尺寸
%   params    - 可选参数结构体, 可由 m080_thruster_params() 生成
%
% 输出 state 结构体:
...
%
% 建模假设:
%   1. 最大静推力来自公开 M080 参数表, 并按供电电压线性插值。
%   2. PWM 死区内输出为 0。
