...
fprintf('图像已保存至 assets/figures/eso_translation_channels.png\n');

figure(fig2);
saveas(fig2, fullfile(pic_dir, 'eso_rotation_channels.png'));
fprintf('图像已保存至 assets/figures/eso_rotation_channels.png\n');

figure(fig3);
saveas(fig3, fullfile(pic_dir, 'eso_performance_vs_current.png'));
fprintf('图像已保存至 assets/figures/eso_performance_vs_current.png\n');
