...
| R009 | M3 | 门控消融 | UCCO variants | 3门控×3噪声 | RMSE | MUST | ⏳ TODO | 需K_obs=10参数 |
| R010 | M4 | Monte Carlo | ALL 4 | 2场景×2失配×10seed | Mean±Std | NICE | ⏳ TODO | 噪声鲁棒性验证 |
| R011 | M4 | 编译论文PDF | — | — | 编译 | MUST | ⏳ TODO | 填入R007数据后编译 |
