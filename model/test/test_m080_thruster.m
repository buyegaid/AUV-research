...
addpath(model_dir, fullfile(project_root, 'model'), fullfile(project_root, 'model', 'params'));

params = m080_thruster_params();
pwm_us = linspace(params.pwm_min_us, params.pwm_max_us, 301);
voltage_v = 24.0;

state = m080_thruster_model(pwm_us, voltage_v, params);
zero_state = m080_thruster_model(1500, voltage_v, params);
...
figure('Name', 'M080 Thruster Model');
