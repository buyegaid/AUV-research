\section{EG-UCCO Observer Design}

The core idea of EG-UCCO is to perform one-step-ahead velocity prediction using the CFD-pre-calibrated dynamics model, map the prediction residual to a current estimate gradient via sensitivity analysis, and update only when the excitation condition is satisfied.
