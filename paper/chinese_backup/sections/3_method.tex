\section{CFD-PCO观测器设计}

CFD-PCO的核心思想是利用CFD预标定的动力学模型进行一步前向速度预测，将预测值与DVL实测速度的残差通过灵敏度分析映射为海流估计的梯度方向，并在激励条件满足时进行更新。图\ref{fig:architecture}给出了CFD-PCO的整体架构。
