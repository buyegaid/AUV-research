...
%% 创建环境
env = createEnv(10,4,"Pitch Control", @step_pitch_control, @reset_pitch_control);
...
trainOpts = rlTrainingOptions( ...
    ...
    StopTrainingValue = 100); %256会导致训练很慢，前期学习迟钝，更新不够灵活

%% ===== 开始训练 =====
trainingStats = train(agent, env, trainOpts);

save("TD3_pitch_260323-1.mat", "agent", "trainingStats");
